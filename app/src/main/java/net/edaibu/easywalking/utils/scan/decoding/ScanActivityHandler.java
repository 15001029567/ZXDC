...
package net.edaibu.easywalking.utils.scan.decoding;
...
import net.edaibu.easywalking.utils.scan.view.ViewfinderResultPointCallback;
...
public final class ScanActivityHandler extends Handler {
	...
	private static final String TAG = ScanActivityHandler.class
			.getSimpleName();

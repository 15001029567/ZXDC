...
public class FileUtils {
    public static String sdcarPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "qiqibike" + File.separator;
    public static String abvertPath = sdcarPath + "abvert" + File.separator;
    ...
    public static void saveBitmap(String fileName, Bitmap bitmap) {
        try {
            mkdirsPath(abvertPath);
            File file = new File(abvertPath + fileName);
            if (file.exists()) {
                return;
            }
            file.createNewFile();

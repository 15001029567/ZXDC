...
public class UpdateVersionUtils {
    ...
    private final String savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/edaibu.apk";
    ...
    public void searchVersion(Context mContext) {
        ...
        HttpMethod.getNewVersion(mHandler);
    }
                    ...
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            if (file.isFile()) {
                                ...
                                if (null != version && version.getData().isEnforce()) {
